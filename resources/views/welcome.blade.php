...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        ...
        <section class="bg-gradient-to-r from-blue-100 to-blue-50 relative overflow-hidden pt-20 pb-24">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p class="text-lg text-gray-600 mb-8">
                            Optimisez votre productivité avec nos solutions SaaS
                        </p>
                        <div class="flex flex-wrap gap-4">
                            <a href="#" class="btn-primary">Démarrer</a>
                            <a href="#" class="btn-outline">En savoir plus</a>
                        </div>
                    </div>
                    <div>
                        <img src="{{ asset('assets/images/hero.png') }}" alt="Hero" class="w-full">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16">
            <div class="container px-4">
                <div class="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <p class="text-gray-600">Découvrez ce qui rend notre solution unique</p>
                </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container px-4">
                <div class="text-center max-w-2xl mx-auto mb-16">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Plans tarifaires</h2>
                    <p class="text-gray-600">Choisissez le plan qui vous convient</p>
                </div>
        ...
        <section class="py-16">
            <div class="container px-4">
                <div class="bg-primary rounded-2xl p-8 md:p-16 text-center">
                    ...
                    <p class="text-white/80 mb-8">Rejoignez des milliers d'entreprises satisfaites</p>
